...
import com.spotlight.platform.userprofile.api.web.exceptionmappers.InvalidParameterTypeExceptionMapper;
import com.spotlight.platform.userprofile.api.web.exceptionmappers.UnsupportedActionExceptionMapper;
...
public class UserProfileApiApplication extends Application<UserProfileApiConfiguration> {
    ...
    private void registerExceptionMappers(Environment environment) {
        ...
        environment.jersey().register(getInstance(InvalidParameterTypeExceptionMapper.class));
        environment.jersey().register(getInstance(UnsupportedActionExceptionMapper.class));
    }
